...
public class Lz4FrameEncoder extends MessageToByteEncoder<ByteBuf> {
    ...
    public Lz4FrameEncoder(LZ4Factory factory, boolean highCompressor, int blockSize, Checksum checksum) {
        ...
        // Ensure we use a heap based ByteBuffer.
    ...
    private ChannelFuture finishEncode(final ChannelHandlerContext ctx, ChannelPromise promise) {
        ...
        footer.setIntLE(idx + COMPRESSED_LENGTH_OFFSET, 0);
        footer.setIntLE(idx + DECOMPRESSED_LENGTH_OFFSET, 0);
        footer.setIntLE(idx + CHECKSUM_OFFSET, 0);
