...
public class Lz4FrameDecoder extends ByteToMessageDecoder {
                ...
                try {
                    switch (blockType) {
                        case BLOCK_TYPE_NON_COMPRESSED: {
                            // Just pass through, we not not update the readerIndex yet as we do this outside of the
                            // switch statement.
                        ...
                        case BLOCK_TYPE_COMPRESSED: {
                            ...
                            decompressor.decompress(inNioBuffer(in),
    ...
    private static ByteBuffer inNioBuffer(ByteBuf buffer) {
